...
class StaffReportPage {
  ...
  async goto(reportName) {
    ...
    // from any other "Staff" link elsewhere in the nav (e.g. the
    // top-level Staff MODULE, distinct from the Reports > Staff CATEGORY).
    //
    ...
    await p.locator(`#${reportsSubmenuId}`).getByRole('link', { name: 'Staff', exact: true }).click();
