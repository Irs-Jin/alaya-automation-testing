...
class MembershipVoucherReportPage {
  ...
  async goto(reportName) {
    ...
    // from any other "Membership Voucher" link elsewhere in the nav (e.g.
    // the top-level Membership Voucher MODULE, distinct from the Reports >
    // Membership Voucher CATEGORY).
    //
    ...
    await p.locator(`#${reportsSubmenuId}`).getByRole('link', { name: 'Membership Voucher', exact: true }).click();
