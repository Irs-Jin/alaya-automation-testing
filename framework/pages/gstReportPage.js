...
class GstReportPage {
  ...
  async goto(reportName) {
    ...
    // from any other "GST" link elsewhere in the nav (e.g. the top-level
    // GST MODULE, distinct from the Reports > GST CATEGORY).
    //
    ...
    await p.locator(`#${reportsSubmenuId}`).getByRole('link', { name: 'GST', exact: true }).click();
