...
REM Runs every POS test (Birthday Setting + Promotion) against UAT, one
...
npx playwright test tests/pos --workers=1

echo.
echo ================================================
echo  POS test run finished. Opening the HTML report...
echo ================================================
