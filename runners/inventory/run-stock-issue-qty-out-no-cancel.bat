...
REM Runs the Stock Issue Qty Out (No Cancel) verification test against UAT with a visible browser.
...
npx playwright test tests/inventory/stock-issue-qty-out-no-cancel.spec.js --headed
