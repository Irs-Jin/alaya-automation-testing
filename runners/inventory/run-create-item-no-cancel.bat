...
REM Runs the Create Item (No Cancel) test case against UAT with a visible browser.
...
npx playwright test tests/inventory/create-item-no-cancel.spec.js --headed
