...
test.describe('Reports > Sales > Item Sales Analysis By Month', () => {

  test('[Happy Path] views, previews, and prints the Item Sales Analysis By Month report', async ({ page }) => {
    ...
    await salesReportPage.previewReport('Item Sales Analysis By Month');
    ...
    await reportPage.screenshot({ path: 'test-results/item-sales-analysis-by-month-report-print.png', fullPage: true }).catch(() => {});
