...
/**
 * templateName confirmed live: "Outstanding Purchase Document by Item
...
test.describe('Reports > Purchase > Outstanding Purchase Document', () => {

  test('[Happy Path] views, previews, and prints the Outstanding Purchase Document report', async ({ page }) => {
    test.setTimeout(90000);
    const purchaseReportPage = new PurchaseReportPage(page);
    await purchaseReportPage.goto('Outstanding Purchase Document');
    ...
    await purchaseReportPage.previewReport('Outstanding Purchase Document by Item Detail');
    ...
    await reportPage.screenshot({ path: 'test-results/outstanding-purchase-document-report-print.png', fullPage: true }).catch(() => {});
