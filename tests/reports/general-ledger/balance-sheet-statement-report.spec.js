...
test.describe('Reports > General Ledger > Balance Sheet Statement', () => {
  ...
  test('[Happy Path] views, previews, and prints the Balance Sheet Statement report', async ({ page }) => {
    ...
    await reportPage.goto('Balance Sheet Statement');
    ...
    await reportTab.screenshot({ path: 'test-results/balance-sheet-statement-report-print.png', fullPage: true }).catch(() => {});
